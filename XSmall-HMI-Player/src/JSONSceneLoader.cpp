...
//         // Обработка условий (упрощенно)
//         if (props.count("conditions") > 0) {
//             // В реальной реализации нужно парсить массив условий
//         }
...
//         if (action == "apply") {
//             onClick = []() { Logger::info("Apply button clicked"); };
//         }
...
//         return std::make_unique<Button>(x, y, width, height, text, font, fontSize, 
